    ...
    return (
        <section id='contact-container'>
            ...
            <div className='contact-links'>
                <a href=""><img className="contact-image" src={require('./linkdin.svg')} /></a>
                <a href="">{gitHubSvg}</a>
                <a href=""><img className="contact-image" src={require('./twitter.svg')} /></a>
            </div>
        </section>
    )
}
...
//             <div className='contact-links'>
//                 <a href=""><img className="contact-image" src={require('./linkdin.svg')} /></a>
//                 <a href=""><img className="contact-image" src={require('./github.svg')} /></a>
//                 <a href=""><img className="contact-image" src={require('./twitter.svg')} /></a>
//             </div>
//         </section>
//     )
